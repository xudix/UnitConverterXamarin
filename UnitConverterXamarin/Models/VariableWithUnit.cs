...
namespace UnitConverterXamarin.Models
{
    ...
    public class VariableWithUnit
    {
        ...
        public VariableWithUnit Convert(String new_prefix = "")
        {
            double new_value = Value * Prefixes.GetPrefixValue(Prefix) / Prefixes.GetPrefixValue(new_prefix);
            return new VariableWithUnit(new_value, Unit, new_prefix);
        }

        public override String ToString() =>
            string.Format("{0:G6} {1}{2}", Value, Prefix, Unit.GetSymbol());
